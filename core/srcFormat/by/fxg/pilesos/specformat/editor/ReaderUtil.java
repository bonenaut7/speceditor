...
public class ReaderUtil {
	...
	public ReaderUtil(Project project, DataOutputStream dataOutputStream) {
		this.project = project;
		this.dataOutputStream = dataOutputStream;
	}
	
	public ReaderUtil(Project project, DataInputStream dataInputStream) {
		this.project = project;
	...
	public void writeAttribute(Attribute attribute) throws IOException {
		...
		if (attribute instanceof BlendingAttribute) {
			...
			if (attribute instanceof TextureLinkedAttribute) {
				...
				FileHandle handle = this.project.projectFolder;
	...
	public Attribute readAttribute() throws IOException {
		...
		switch (alias) {
			...
			case "reflectionTexture": {
				...
				FileHandle handle = path.equals("-") ? null : this.project.projectFolder.child(path);
				TextureRegion region = new TextureRegion(handle == null ? GameManager.standartDiffuse : new Texture(handle));
