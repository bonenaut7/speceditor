...
public class DefaultRenderer implements IRendererType {
	...
	public DefaultRenderer(PMObjectExplorer pmObjectExplorer, Camera camera) {
		this.camera = camera;
	...
	public void passRender() {
		...
		if (Game.get.getInput().isKeyboardDown(Keys.F12, false)) AWTScreenshot.captureToClipboardAsync(0, 0, Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
