...
public class EditorPaneHitboxStack extends EditorPane implements ISTDInputFieldListener {
	...
	private class SpecFlagsBlock extends URenderBlock {
		...
		public SpecFlagsBlock(EditorPaneHitboxStack parent) {
		...
		private void updateBlock(ElementHitboxStack hitbox) {
	...
	private class BulletFlagsBlock extends URenderBlock {
		...
		public BulletFlagsBlock(EditorPaneHitboxStack parent) {
			super("Bullet Flags");
			this.parent = parent;
