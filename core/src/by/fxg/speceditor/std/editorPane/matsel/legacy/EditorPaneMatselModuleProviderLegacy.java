...
public class EditorPaneMatselModuleProviderLegacy implements IEditorPaneMatselModuleProvider {
	...
	@SafeVarargs
	public EditorPaneMatselModuleProviderLegacy(Class<? extends Attribute>... bannedAttributes) {
