...
import by.fxg.speceditor.tools.g3d.PBRTextureLinkedAttribute;
			...
			protected int renderInside(int y, Batch batch, ShapeDrawer shape, Foster foster) {
				...
				for (int i = 0; i != 3; i++) {
					...
					for (int j = 0; j != 3; j++) {
						...
						drawWheelInput(ter.renderable.getTransform(EnumTransform.values()[i]), j, shape, this.x + 24, y - 20, 12, 14);
