...
public class UDropdownClick extends UIElement implements IFocusable {
	...
	public UDropdownClick(String name, int x, int y, int width, int height, int dsy, String... variants) {
	...
	public void render(ShapeDrawer shape, Foster foster) {
		if (this.isFocused()) {
			...
			for (int i = 0; i != this.variants.length; i++) {
				...
				if (this.isMouseOver(this.x, this.y - this.dropHeight * i - this.dropHeight - 2, this.width, this.dropHeight)) {
