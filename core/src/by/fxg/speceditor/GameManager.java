...
public class GameManager {
	...
	public GameManager(boolean initBullet) {
		if (initBullet) Bullet.init();
		this.assetManager = new AssetManager();
		//this.assetManager.setLoader(ebtMapConfig.class, ".bcf", new ebtMapConfigLoader(new InternalFileHandleResolver()));
		...
		//this.assetMarkers.put("bcf", ebtMapConfig.class);
