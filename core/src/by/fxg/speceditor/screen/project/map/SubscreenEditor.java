...
import by.fxg.speceditor.screen.project.map.editor.ModulePMOE;
import by.fxg.speceditor.screen.project.map.editor.ModuleProject;
import by.fxg.speceditor.screen.project.map.editor.ModuleViewport;
...
public class SubscreenEditor extends BaseSubscreen {
	...
	public SubscreenEditor(ScreenProject parent, int x, int y, int width, int height) {
		...
		this.moduleProject = new ModuleProject(this);
